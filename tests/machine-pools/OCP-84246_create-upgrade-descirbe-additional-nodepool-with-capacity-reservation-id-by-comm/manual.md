...
## Step
Create machinepool via rosacli command with flags "--instance-type" ,"--availability-zone"/"--subnet","--replicas" and "--capacity-reservation-id", their values are same with the one created in step1
...
- Choose autoscaling setting
- Input invalid reservation id
- Upgrade the machinepool
...
```
E: Failed to schedule upgrade for machine pool 'ii' in cluster '2ktf5ln6lmllejp5p8orf40o84u5mop8': status is 400, identifier is '400', code is 'CLUSTERS-MGMT-400', at '2025-08-26T09:49:51Z' and operation identifier is 'd334f3ca-897a-43a5-b3b1-723af4616f29': Capacity reservations are currently incompatible with nodepool upgrade. Please remove any upgrade policies from nodepool 'ii' to make use of capacity reservation
```
