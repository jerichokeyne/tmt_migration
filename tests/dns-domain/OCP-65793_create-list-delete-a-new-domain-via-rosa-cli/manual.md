...
the dns base domain for clusters with Cross Account VPC arch is defined per env:   
for hcp dns domain, use i3, s3 and p3 respectively for each env, while using i1, s1 and p1 respectively for each env for classic clusters.

## Step
List all existing domain via rosa cli  
...
## Step
List all dns domian with '--hosted-cp' flag
...
## Expect
There will be more domains listed than when you run just "rosa list dns-domain --hosted-cp", and all the domains will have the architecture has "hcp"  
...
27qz.s3.devshift.org 2023-09-25T14:42:09Z No hcp  
...
4rj8.s3.devshift.org 2023-08-10T02:53:51Z No hcp  
5vco.s3.devshift.org 2023-05-17T11:35:36Z No hcp  
...  
