...
1. Test HCP cluster creation using the `--default-ingress-route-selector` flag.

## Expect

An error stating `Updating default ingress settings is not supported for Hosted Control Plane clusters`.
