...
## Step
Create account with not invalid prefix  
$ rosa create account-roles --prefix ^^^^ --mode auto -y

## Expect
Error output  
[xueli@xueli-work ~]$ rosa create account-roles --prefix ^^^^ --version 4.7 --mode auto -y  
...
## Step
Create account with longer than 32 chars prefix  
$ rosa create account-roles --prefix iamlongerthan32charactersiamlongerthan32characters --mode auto -y

## Expect
Error output:  
[xueli@xueli-work ~]$ rosa init account --prefix iamlongerthan32charactersiamlongerthan32characters --version 4.7 --mode auto -y  
...
## Step
Create account with invalid mode  
$ rosa create account-roles --prefix valid --mode invalid -y

## Expect
There should be Error output:  
[xueli@xueli-work linux]$ rosa create account-roles --prefix valid --version 4.7 --mode invalid -y  
E: Invalid mode. Allowed values are [auto manual]

## Step
Create account with invalid mode with invalid permission boundary  
$ rosa create account-roles --prefix valid --mode auto -y --permissions-boundary invalid

## Expect
[xueli@xueli-work ~]$ rosa create account-roles --permissions-boundary non-existed --version 4.8 --mode auto -y  
E: Expected a valid policy ARN: arn: invalid prefix

## Step
Create account with non-existing permission boundary  
$ rosa create account-roles --prefix valid --mode auto -y --permissions-boundary arn:aws:iam::301721915996:policy/non-existing

## Expect
There should be error output  
[xueli@xueli-work ~]$ rosa create account-roles --permissions-boundary arn:aws:iam::301721915996:policy/xueli-openshift-cloud-credential-operator-cloud-credential-operanon-existed --version 4.8 --mode auto -y  
I: Creating roles using 'arn:aws:iam::301721915996:user/xueli'  
...
## Step
Create account-roles with the force-policy-creation and manual mode  
