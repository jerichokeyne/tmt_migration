...
## Step
Create Github IDP in the interactive mode.  
...
## Step
Create Gitlab IDP in the interactive mode.  
\#rosa create idp -c <clusrer_id>  
\#rosa create idp -c <clusrer_id> -i
...
## Step
Create Google IDP in the interactive mode.  
\#rosa create idp -c <clusrer_id>  
\#rosa create idp -c <clusrer_id> -i
...
## Step
Create Ldap IDP in the interactive mode.  
\#rosa create idp -c <clusrer_id>  
\#rosa create idp -c <clusrer_id> -i
...
## Step
Create OpenID IDP in the interactive mode.  
\#rosa create idp -c <clusrer_id>  
\#rosa create idp -c <clusrer_id> -i
