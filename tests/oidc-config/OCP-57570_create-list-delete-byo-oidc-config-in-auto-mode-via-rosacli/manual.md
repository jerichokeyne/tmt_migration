...
$ ./rosa create oidc-config --mode auto --region us-east-1 -yI: This command will create a S3 bucket populating it with documents to be compliant with OIDC protocol. It will also create a Secret in Secrets Manager containing the private key.  
...
yuwan1-mac:rosa yuwan$ ./rosa create oidc-config --prefix yw0207bcca1 --mode auto   
