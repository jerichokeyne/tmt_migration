...
## Step
Create hosted-cp cluster with s3 and cloudwatch log-fwd-config
...
## Expect
yuwan@yuwan-mac 1.2.58rc2 % ./rosa list log-forwarders -c 2n7af4dqcl4974cfi0ihv1v2juhvdu98  
ID TYPE STATUS  
2n7af5bhorhlrguqh5hovtnen0l6p9pr S3 ready  
2n7af59a8kv3m3btfh64vbl5198lh4tk CloudWatch ready  
  
yuwan@yuwan-mac 1.2.58rc2 % ./rosa list log-forwarders -h  
...
- Both S3 and cloud watch log forwarders are listed with above fields  
...
## Expect
yuwan@yuwan-mac 1.2.58rc2 % ./rosa describe log-forwarder -c 2n7af4dqcl4974cfi0ihv1v2juhvdu98 -h  
...
- For CloudWatch  log forwad. there are bellow fields with correct values  
yuwan@yuwan-mac 1.2.58rc1 % ./rosa describe log-forwarder 2n6ifmg0i5h5l67pp1ceqnr832rd4hgu -c 2n6ifln475lv578p11fhcr4jjd9s1cp7  
...
- For S3 log forwad. there are bellow fields with correct values  
  
yuwan@yuwan-mac 1.2.58rc1 % ./rosa describe log-forwarder 2n6ifmj56i1dqek6i4skutveevqvips8 -c 2n6ifln475lv578p11fhcr4jjd9s1cp7  
...
- If the log forward id is not-existed, reports "E: failed to get log forwarder '2n7af59a8kv3m3btfh64vbl5198lh4tkaa'"

## Step
Edit log forwarders with '--log-fwd-config' flag  
- Update applications and groups  
- Update cloudwatch_log_role_arn/cloudwatch_log_group_name/s3_config_bucket_name/s3_config_bucket_prefix  
...
- Check the result with `rosa describe log-forwarder` , the result should be expexcted

## Step
Check validations:of editing  
- In the yaml file, without required field cloudwatch_log_role_arn/cloudwatch_log_group_name/s3_config_bucket_name  
- Without applications or groups  
- Use different cloud forward type of struct to update  
- role or s3 name is not existed
...
## Expect
yuwan@yuwan-mac 1.2.58rc2 % ./rosa delete log-forwarder -h   
...
yuwan@yuwan-mac 1.2.58rc2 % ./rosa delete log-forwarder -c 2n7af4dqcl4974cfi0ihv1v2juhvdu98 2n7af5bhorhlrguqh5hovtnen0l6p9pr  
? Are you sure you want to delete log forwarder '2n7af5bhorhlrguqh5hovtnen0l6p9pr'?? (y/N)   
yuwan@yuwan-mac 1.2.58rc2 % ./rosa delete log-forwarder -c 2n7af4dqcl4974cfi0ihv1v2juhvdu98 2n7af5bhorhlrguqh5hovtnen0l6p9pr -y  
I: Successfully deleted log forwarder '2n7af5bhorhlrguqh5hovtnen0l6p9pr' from cluster '2n7af4dqcl4974cfi0ihv1v2juhvdu98'  
  
- The log forward should be deleted sucessfully.  
- The deleted one will not display in the result of `rosa list/describe log-forwarder`  
  
- Deleting not existed one will report "E: log forwarder '2n7af5bhorhlrguqh5hovtnen0l6p9praa' not found"

## Step
Delete all log forwarders then create new ones  
- Create both s3 and CW log forwarder  
- Create one of s3 and CW log forwarder  
- Create new one when there is already log forwarder existed

## Expect
- The new log forwarder should be created.  
  
yuwan@yuwan-mac 1.2.58rc2 % ./rosa create log-forwarder -c 2n7af4dqcl4974cfi0ihv1v2juhvdu98 --log-fwd-config ./s3cw.yaml   
