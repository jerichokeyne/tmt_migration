...
## Expect
The user access should be added. Login the cluster console, the users are added under the groups.
...
## Expect
The user access is revoked successfully. The user is not in the users list. Login the cluster console, the user is not under the group.
