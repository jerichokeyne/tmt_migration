...
## Step
Create an external authentication provider in interactive mode.
...
- The help message in the interactive mode should be correct.
...
## Step
Delete an external authentication provider in interactive mode.

## Expect
It will go into interactive mode and confirm deletion.
