...
create hcp with invalid value for --registry-config-allowed-registries-for-import flag
...
create hcp with --registry-config-blocked-registries and --registry-config-allowed-registries at same time
...
create registry config to a non-hcp cluster
