...
rosa list access-request -c 2efdhq5agtt3l3f7grhdhn47pli540n4

## Expect
STATE ID CLUSTER ID UPDATED AT  
Pending 2nZS9zZPUMQPm4EuqN0xV0ATkDs 2efdhq5agtt3l3f7grhdhn47pli540n4 Thu Oct 17 15:29:17 UTC 2024  
...
rosa create decision --access-request=2nZS9zZPUMQPm4EuqN0xV0ATkDs --decision Approved
...
rosa create decision --access-request=2nZS9zZPUMQPm4EuqN0xV0ATkDs --decision Denied --justification Testing
...
a. rosa list access-request  
b. rosa list access-request -c $CLUSTER_ID1  
c. rosa list access-request -c $CLUSTER_ID2
